...
$MessageBody = "Hãy cùng tham gia J2Team Community để cùng chia sẻ và học hỏi!"
$MessageTitle = "Hãy tham gia J2Team Community!"
$Result = [System.Windows.MessageBox]::Show($MessageBody,$MessageTitle,$ButtonType,$MessageIcon)

if ($Result = "OK"){
    Start-Process "https://www.facebook.com/groups/j2team.community/"
}
